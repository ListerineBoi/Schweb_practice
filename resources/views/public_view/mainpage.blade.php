...
@section('content')
    ...
    <div class="col-xl-12 row justify-content-center pb-xl-2 mb-xl-0 mx-xl-0">
        <div class="col-xl-7 mt-xl-5 ">
            <div class="col-xl-12">
                ...
                <h1 class="Poppins-bold text-center display-5 mb-5 d-none d-xl-block d-xxl-none" style="color: #162455"> Kalender Akademik</h1>
        ...
        <div class="col-xl-5" style="background-color: #402E32">
            ...
            <h1 class="Poppins-bold text-center display-5 mb-5 mt-xl-5 d-none d-xl-block d-xxl-none" style="color: #FFC36B">Pengumuman</h1>
            <div class="row">
    ...
    <div class="col-xl-12 py-xxl-5 py-xl-1 mx-xl-0 row justify-content-center" style="background-color: #FFEECA">
        <div class="col-xxl-3 offset-xxl-0 offset-xl-1 col-xl-2 py-xl-5">
        ...
        <div class="col-xxl-5 col-xl-7 offset-xxl-1 offset-xl-2 ps-xxl-0 ps-xl-5 py-xl-5">
    ...
    <div class="col-xl-12 py-xl-5 mx-xl-0 row justify-content-center" style="background-color: #B4AA99">
        <div class="col-xl-12 pt-xl-3 row justify-content-center">
            ...
            <h1 class="Poppins-bold display-6 text-light col-xl-9 me-xl-1 d-none d-xl-block d-xxl-none"> Artikel</h1>
            ...
            <p class="Poppins fs-4 text-light col-xl-9 d-none d-xl-block d-xxl-none" >Publikasi artikel oleh staff dan guru SMA ABC.</p>
            <div class="col-xl-1 d-none d-xl-block d-xxl-none"></div>
            <div class="col-xl-11 row row-cols-1 row-cols-md-3 gx-xxl-5 gx-xl-5 justify-content-center">
                <div class="col-xxl-3 col-xl-4">
                  <div class="card h-100">
                    ...
                    <div class="d-flex"><a name="" id="" class="btn btn-primary Poppins col-xl-3 m-xl-2" href="#" role="button">lihat</a>
                        <i class="fa-regular fa-share-nodes fa-2xl mt-xl-4 offset-xl-7"></i>
                    </div>
    ...
    <div class="col-xl-12 py-xl-5 mx-xl-0 row justify-content-center" style="background-color: #FFEECA">
        <div class="col-xl-12 pt-xl-3 row justify-content-center">
            <h1 class="Poppins-bold display-3 col-xl-9 d-none d-xxl-block" style="color: #162455"> Galeri Kegiatan</h1>
            <h1 class="Poppins-bold display-6 col-xl-9 me-xl-1 d-none d-xl-block d-xxl-none" style="color: #162455"> Galeri Kegiatan</h1>
            <div class="col-xl-1 d-none d-xl-block d-xxl-none"></div>
            <p class="Poppins fs-4 col-xl-9 d-none d-xxl-block" style="color: #162455">Publikasi kegiatan oleh staff dan guru SMA ABC.</p>
            <p class="Poppins fs-4 col-xl-9 d-none d-xl-block d-xxl-none" style="color: #162455">Publikasi kegiatan oleh staff dan guru SMA ABC.</p>
            <div class="col-xl-1 d-none d-xl-block d-xxl-none"></div>
            <div class="col-xxl-12 col-xl-11 row row-cols-1 row-cols-md-3 gx-xxl-5 gx-xl-5 justify-content-center mb-xxl-5">
                <div class="col-xxl-3 col-xl-4">
                    <div class="card text-bg-dark">
                        ...
                        <div class="card-img-overlay pb-xl-0 pt-xl-5 overlay-dark">
                            ...
                            <h5 class="card-title Poppins-bold fs-6 mb-xl-0 pt-xl-5 mt-xxl-5 d-xl-block d-xxl-none">17 Agustus 2022</h5>
                            <p class="card-text Poppins mb-xl-0">Galeri Upacara 17 Agustus 2022</p>
                            <p class="card-text Poppins"><small>oleh: STAFF DOKUMENTASI OSIS SMA ABC</small></p>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-4">
